...
import (
	...
	packethealthcheck "github.com/gardener/gardener-extensions/controllers/provider-packet/pkg/controller/healthcheck"
...
func NewControllerManagerCommand(ctx context.Context) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			configFileOpts.Completed().ApplyHealthCheckConfig(&packethealthcheck.DefaultAddOptions.HealthCheckConfig)
			healthCareCtrlOpts.Completed().Apply(&packethealthcheck.DefaultAddOptions.Controller)
