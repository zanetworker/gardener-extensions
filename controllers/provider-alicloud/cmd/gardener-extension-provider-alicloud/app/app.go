...
import (
	...
	alihealthcheck "github.com/gardener/gardener-extensions/controllers/provider-alicloud/pkg/controller/healthcheck"
...
func NewControllerManagerCommand(ctx context.Context) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			configFileOpts.Completed().ApplyHealthCheckConfig(&alihealthcheck.DefaultAddOptions.HealthCheckConfig)
			healthCareCtrlOpts.Completed().Apply(&alihealthcheck.DefaultAddOptions.Controller)
