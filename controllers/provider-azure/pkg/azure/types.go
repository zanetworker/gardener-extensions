...
const (
	...
	// CloudProviderWorkerConfigName is the name of the configmap containing the cloud provider worker config.
	CloudProviderWorkerConfigName = "cloud-provider-worker-config"
