...
import (
	...
	azurehealthcheck "github.com/gardener/gardener-extensions/controllers/provider-azure/pkg/controller/healthcheck"
...
func NewControllerManagerCommand(ctx context.Context) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			configFileOpts.Completed().ApplyHealthCheckConfig(&azurehealthcheck.DefaultAddOptions.HealthCheckConfig)
			healthCareCtrlOpts.Completed().Apply(&azurehealthcheck.DefaultAddOptions.Controller)
