...
import (
	...
	gcphealthcheck "github.com/gardener/gardener-extensions/controllers/provider-gcp/pkg/controller/healthcheck"
...
func NewControllerManagerCommand(ctx context.Context) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			configFileOpts.Completed().ApplyHealthCheckConfig(&gcphealthcheck.DefaultAddOptions.HealthCheckConfig)
			healthCareCtrlOpts.Completed().Apply(&gcphealthcheck.DefaultAddOptions.Controller)
